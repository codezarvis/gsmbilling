        ...
        <div id="main">
            ...
            <div id="page" class="box">
                ...
                <div id="search-in">
                    ...
                    <div id="heading"><fmt:message key="lbl.welcome"/>, <c:out value = "${operator.operatorName}"></c:out> 
                ...
                <div class="box">
                    <div id="col-l">
                        ...
                        <div class="title01">    
                            ...
                            <ul>
                                <li> <a href="ViewClientsController"><fmt:message key="lbl.userList"/></a></li><br/>
                                <li> <a href="bill.jsp"><fmt:message key="lbl.genBill"/></a></li><br/>
