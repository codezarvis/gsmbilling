...
<%@page import="com.gsm.domain.sub.MeterOperator"%>
                    ...
                    <div id="col-l">
                        ...
                        <div class="title01"> 
                            ...
                            <div class="title01-in">
                                ...
                                <h2 align="center" class="ico-list"><fmt:message key="lbl.opeList"/></h2>
                                <hr/>
                            </div>
                            ...
                            <div id="tableView1">
                                ...
                                <table align="center" border="">
                                    ...
                                    <tr>
                                        <td><fmt:message key="lbl.opeID"/></td>
                                        <td><fmt:message key="lbl.opeName"/></td>
                                        <td><fmt:message key="lbl.area"/></td>
                                        <td><fmt:message key="lbl.wardNum"/></td>
                                        <td><fmt:message key="lbl.city"/></td>
                                    ...
                                    <c:forEach items="${OpeList}" var="operator">
                                        <tr>
                                            ...
                                            <td><c:out value="${operator.operatorId}"></c:out></td>
                                            <td><c:out value="${operator.operatorName}"></c:out></td>
                                            <td><c:out value="${operator.area}"></c:out></td>
                                            <td><c:out value="${operator.wardNo}"></c:out></td>
                                            <td><c:out value="${operator.city}"></c:out></td>
